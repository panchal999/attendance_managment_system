<?php
	...
	$sql = "SELECT name,sid,rollno FROM student_new where $strno=sid";//rollno to sid
		...
		<div class="container">
			...
			<?php
				...
				echo "<table class='table table-striped table-hover reports-table'>";
					 ...
					 $ssql = "SELECT id FROM student_subject_new where $tempid=sid";
                ...
                <div class="panel-body">
                  <p>Present Days out of Working Days:&nbsp;<strong>' . $present . '/' . $tlec . '</strong></p>
									<p>Attendance Percentage:&nbsp;<strong>' .
									round($tper,2). '&nbsp;%</strong></p>
                </div>
              </div>';
