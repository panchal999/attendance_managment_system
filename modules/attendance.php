...
INNER JOIN user_subject WHERE user_subject.id = subject.id AND user_subject.uid = {$_SESSION['uid']}  ORDER BY subject.name";
			...
			<table class="table table-striped table-hover">
				...
				<?php
					...
					$qu = "SELECT student_new.sid, student_new.name, student_new.rollno from student_new INNER JOIN student_subject_new WHERE student_new.sid = student_subject_new.sid AND student_subject_new.id  = {$_GET['subject']}  ORDER BY student_new.sid";
					$stu=$conn->query($qu);
