		...
		<div class="col-md-12">
			...
			<?php
				...
				if(($sdate<$t) && ($edate<=$t) && ($edate >= $sdate))
				{
					...
					$query_student = "SELECT student_new.sid, student_new.name, student_new.rollno from student_new INNER JOIN student_subject_new WHERE student_new.sid = student_subject_new.sid AND student_subject_new.id  = {$selsub}  ORDER BY student_new.sid";
