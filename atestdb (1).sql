...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2018 at 09:41 PM
...
(4, 1, 1522800000, 1, 1, 2),
(5, 2, 1522800000, 0, 1, 2),
(7, 1, 1522713600, 1, 1, 2),
(8, 2, 1522713600, 0, 1, 2),
(10, 1, 1522627200, 1, 1, 2),
(11, 2, 1522627200, 0, 1, 2),
(13, 1, 1522886400, 1, 7, 5),
(14, 2, 1522886400, 1, 7, 5),
(16, 1, 1522886400, 1, 3, 3),
(17, 2, 1522886400, 0, 3, 3),
(19, 1, 1522713600, 1, 3, 3),
(20, 2, 1522713600, 1, 3, 3),
(22, 1, 1522800000, 1, 3, 3),
(23, 2, 1522800000, 1, 3, 3),
(25, 1, 1522281600, 1, 1, 2),
(26, 2, 1522281600, 1, 1, 2),
(28, 2, 1522800000, 1, 1, 6),
(30, 2, 1522627200, 1, 1, 6),
(32, 1, 1522972800, 1, 1, 2),
(33, 2, 1522972800, 1, 1, 2);
...
(1, 'apv', 'apv', 1, 'apv@gmail.com', 1, 14890601),
(2, 'jhb', 'jhb', 1, 'jhb@gmail.com', 1, 14890601),
(3, 'spm', 'spm', 1, 'spm@gmail.com', 1, 14890601),
(4, 'pmc', 'pmc', 1, 'pmc@gmail.com', 1, 14890601),
(5, 'bsb', 'bsb', 1, 'bsb@gmail.com', 1, 14890601),
(6, 'sss', 'sss', 1, 'sss@gmail.com', 1, 6),
(7, 'msb', 'msb', 1, 'msb@gmail.com', 1, 535365),
(8, 'ch1', 'ch1', 2, 'ch1@gmail.com', 1, 546464),
(9, 'ch2', 'ch2', 2, 'ch2@gmail.com', 1, 353),
(10, 'mh1', 'mh1', 3, 'mh1@gmail.com', 1, 565465),
(11, 'itfac1', 'itfac1', 4, 'itfac1@gmail.com', 1, 54545454),
(12, 'admin', 'admin', 1, 'admin@gmail.com', 1, 14453343);
...
--
ALTER TABLE `attendance`
  MODIFY `aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
-- AUTO_INCREMENT for table `student_new`
--
ALTER TABLE `student_new`
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `fk_atd_uid` FOREIGN KEY (`uid`) REFERENCES `user_new` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_stu_atd` FOREIGN KEY (`sid`) REFERENCES `student_new` (`sid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `department_subject`
--
ALTER TABLE `department_subject`
  ADD CONSTRAINT `fk_dept_sub` FOREIGN KEY (`did`) REFERENCES `department` (`did`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_dept_sub2` FOREIGN KEY (`id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `department_user`
--
ALTER TABLE `department_user`
  ADD CONSTRAINT `fk_did_dept` FOREIGN KEY (`did`) REFERENCES `department` (`did`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_uid_user` FOREIGN KEY (`uid`) REFERENCES `user_new` (`uid`);

--
-- Constraints for table `student_subject_new`
--
ALTER TABLE `student_subject_new`
  ADD CONSTRAINT `fk_stu_sub` FOREIGN KEY (`sid`) REFERENCES `student_new` (`sid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_stu_sub1` FOREIGN KEY (`id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `user_subject`
--
ALTER TABLE `user_subject`
  ADD CONSTRAINT `user_sub_fk1` FOREIGN KEY (`uid`) REFERENCES `user_new` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `user_sub_fk2` FOREIGN KEY (`id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
